...
<div id="about-group" class="">
        <!-- <aside class="w-100 d-none d-md-block">
            <div class="table-of-content">
                <ul class="list-group">
                    <a href="#about-us">
                        <li class="list-group-item active" name="about-us">About Us</li>
                    </a>
                ...
                <div id="about-premise" class="">
                    <div class="container pyb">
                        ...
                        <div>
                            ...
                            <p>It is important to note that it is not enough to just be in school, the quality of education has to be good for a child to thrive.</p>
                            <p>If quality education is not just a basic human right but also fundamental in closing the gaps created by inequality and ultimately reducing global poverty, how then do we democratize access to quality education for young people in rural communities across Nigeria?</p>
                            <p>If the prevalent school curriculums are not sufficient to prepare young people for the future, how then can we transform education beyond the confines of the classrooms?</p>
                            <p>It is on this premise, Bluvard Education Initiative was birthed- to bridge the gap between education as it is - to education as it should be for children and youths living in rural communities.    </p>
                        </div>                        
                    </div>
                </div>
                <div id="about-vision-mission" class="">
                    <div class="container pyb">
                        <div class="row">
                            <div class="col-md-7 ">
                            ...
                            <div class="col-md-5 p-4 p-md-5">
                                <div class="values">
                                    ...
                                    <div>
                                        <ul class="list">
                                            <li class="list-item">F - Faith Driven</li>
                                            <li class="list-item">I - Integrity</li>
                                            <li class="list-item">R - Resilence</li>
                                            <li class="list-item">E - Empathy</li>
                                        </ul>
                                        <ul class="list">
                                            <li class="list-item">I- Ingenuity</li>
                                            <li class="list-item">C - Courage</li>
                                            <li class="list-item">E - Excellence</li>
                                        </ul>
                                    </div>                        
                                </div>
                            </div>
