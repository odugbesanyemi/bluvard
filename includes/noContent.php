<div class="d-flex flex-column justify-content-center align-items-center" style="padding:40px;margin-bottom:50px;">
    <div class="wrapper text-center" data-aos="fade-in">
        ...
        <h3 class="mb-3">We're making this content available, Kindly check back later.</h3>
        <a href="<?php echo $_SERVER['HTTP_REFERER'] ?>" class="text-dark mt-3"><i class="fa fa-long-arrow-left me-3" aria-hidden="true"></i>go back</a>
    </div>
</div>